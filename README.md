...
This is an ALX collaboration project on Shell between Gideon Peace Ajala and Kolawole Ibrahim
Written with: C language Shell.

Betty linter General Requirement:
...
Description: Ayeromara Olumide & Joshua Dimeji Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh). Additional functions are also included. This program was written entirely in C as a milestone project for ALX Africa Software Engineering.
